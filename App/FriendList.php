...
class FriendList extends Database{
	...
	public function getFriendList()
	{
		...
		foreach ($listFriends as $friend) {
			echo "<li> " . $friend['user_pseudo']."<a href='amis.php?delete=". $friend['friendsList_id'] ."' class='red'> supprimer</a></li>";
		}
	...
	{	
		...
		if ($row == 0) {
			...
			if ($row == 0) {
				...
				echo '<p class="red">Vous etes déjà amis !<p>';
			}
		}else{
				//Sinon on affiche l'erreur
				echo '<p class="red titre">Vous etes déjà amis !<p>';
		}
	}
}